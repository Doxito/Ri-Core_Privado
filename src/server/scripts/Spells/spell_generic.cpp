...
class spell_generic_clon_weapon : public SpellScriptLoader
{
    public:
        spell_generic_clon_weapon() : SpellScriptLoader("spell_generic_clon_weapon") { }

        class spell_generic_clon_weapon_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_generic_clon_weapon_SpellScript);
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_generic_clon_weapon_SpellScript::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_generic_clon_weapon_SpellScript();
        }
};
